...
const String baseUrl = 'http://172.16.218.160:3000/';
...
const String getBloodReports =
    '${baseUrl}api/blood-reports/'; // Ensure this expects userId
...
const String getSteps = '${baseUrl}api/steps/'; // Added for fetching steps
const String submitSteps = '${baseUrl}api/steps'; // Added for submitting steps
